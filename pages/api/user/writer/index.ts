...
import { 
  writerCreateSchema, 
  writerUpdateSchema } from "@/api-lib/schemas/user.schema";
import { 
  createWriterHandler, 
  getCurrentWriterHandler, 
  updateWriterHandler } from "@/api-lib/controller/writer.controller";
...
// get current user
handler.get(verifyUser, getCurrentWriterHandler);
